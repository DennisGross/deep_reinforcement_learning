...
class DQNAgent:
    ...
    def __init__(self, input_dimensions, action_dimensions, memory_size=10000,
                 epsilon=1, epsilon_dec=0.9996, epsilon_end=0.1, learning_rate=0.01, gamma=0.99, batch_size=64, replacing_counter=5, model_name="model"):
        # Environment related
        self.input_dimensions = input_dimensions
        self.action_dimensions = action_dimensions
        # Hyperparameter
        ...
        self.neural_network_next = DuelingDeepQNetwork(input_dimensions=self.input_dimensions,
                                                  action_dimensions=self.action_dimensions,
                                                  learning_rate=self.learning_rate)
    ...
    def learn(self):
        if self.experience_replay.contains_more_elements_than_batch_size(self.batch_size):
            ...
            V_s_, A_s_ = self.neural_network_next.forward(new_state_batch)
